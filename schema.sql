...
INSERT INTO Posts (users_id, animal_id, post_text, imageURL, post_time) VALUES (1, 1, 'Wileys lion ', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUkwe-Ws_DAXRW-ApsE2ZrAZTSQEkGnSGhCg&usqp=CAU', now());
INSERT INTO Posts (users_id, animal_id, post_text, imageURL, post_time) VALUES (2, 2, 'Allys tiger text ', 'https://images.theconversation.com/files/330851/original/file-20200427-145560-1nlgr5h.jpg', now());
INSERT INTO Posts (users_id, animal_id, post_text, imageURL, post_time) VALUES (3, 3, 'Jakobs elephant text ', 'https://assets.nrdc.org/sites/default/files/styles/full_content--retina/public/media-uploads/wlds43_654640_2400.jpg?itok=LbhnLIk9', now());
INSERT INTO Posts (users_id, animal_id, post_text, imageURL, post_time) VALUES (4, 4, 'Elises snake text ', 'https://thewhiskerchronicles.files.wordpress.com/2014/02/664px-eastern_indigo_snake.jpg', now());
INSERT INTO Posts (users_id, animal_id, post_text, imageURL, post_time) VALUES (5, 5, 'Rays orangutan text ', 'https://static.scientificamerican.com/blogs/cache/file/65367319-B08B-4C77-8A2F42A5E05C8B53_source.jpg', now());
